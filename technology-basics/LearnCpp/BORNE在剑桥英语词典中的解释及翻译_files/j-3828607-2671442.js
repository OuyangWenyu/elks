  ...
  var o = {
        ...
        adVisibilityListener: function() {
            ...
            o.addEventListener('advisibility', function(currentVisibility) {
                var aboveThreshold = !!(currentVisibility && currentVisibility >= o.viewableImpressionThreshold * 100), visibility = {
    ...
    (function() {
        var p = "3828607", n = JSON.parse('[]'), w = window, f = function(s) {
    ...
    var data = {
        params:window.ftParams_3828607||'',
        GUID:window.ftGUID_3828607||'99999999999',
        confID:window.ftConfID_3828607||'0',
        ftReturn: window.ftReturn_3828607||'',
        keyword:window.ftKeyword_3828607||'',
        ftId:window.ftId_3828607||'',
        imp:window.ftImp3828607,
        ftImpId:window.ftImp3828607 && window.ftImp3828607.impID || '',
        campaignID:'109643',
        cID:'102990',
        pID:'3828607',
        creativeID:'2671442',
        exttrack:[],
        extscript:[""],
        clickTags: ["http://servedby.flashtalking.com/click/8/109643;3828607;2671442;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.workday.com/en-us/industries/hospitality.html?camp=7011B000002hRvV%26eid%3Denus_ba_db_deba_wd_hospedu_web_17.1340"],
        placementDescription:'WorkdayHospitality300x250ENGHTMLNA',
        width:300,
        height:250,
        adType:'HTML_onpage'.toLowerCase(),
        siteName:'Flashtalkingcom',
        divID:'ftdiv3828607',
        phID:'ftpos3828607',
        frameID:'ftframe3828607',
        expID:'ftexpframe3828607',
        altImgID:'ftalt3828607',
        altText:'Click here',
        altImgTarget:'_blank',
        altimghref:'http://servedby.flashtalking.com/click/8/109643;3828607;2671442;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.workday.com/en-us/industries/hospitality.html?camp=7011B000002hRvV%26eid%3Denus_ba_db_deba_wd_hospedu_web_17.1340',
        altImg:'http://servedby.flashtalking.com/imp/8/109643;3828607;204;gif;Flashtalkingcom;WorkdayHospitality300x250ENGHTMLNA/?',
        viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/109643;3828607;271;pixel;Flashtalkingcom;WorkdayHospitality300x250ENGHTMLNA/?',
        stump:'http://servedby.flashtalking.com',
        jsurl:'http://cdn.flashtalking.com/xre/382/3828607/2671442/js/j-3828607-2671442.js',
        file:'http://cdn.flashtalking.com/102990/2671442/index.html',
        safeFrame: window.$sf && window.$sf.ext || false,
        serveDOM:'http://cdn.flashtalking.com',
        statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?140435363-3828607;2671442;',
        adVis:false ? 1 : 0,
        centreAd:true,
        mvt:true,
        segment:window.ftSegment_3828607||'',
        segmentList:window.ftSegmentList_3828607||[],
        ...
        baggyFrameLimit:15,
        append:!!(window.ftImp3828607 && window.ftImp3828607.jsAppend),
        ...
        pageVisible: 'maybe',
        altimgborder: '0',
        secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3828607')&&/^https:/.test(document.getElementById('ftscript_m3828607').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
        scriptLocation: document.getElementById('ftscript_m3828607'),
        ...
        qsVars:[
            ['ftguid', 'ftGUID_3828607'],
            ['ftcfid', 'ftConfID_3828607'],
            ['fttime', 'ftTimestamp_3828607'],
            ['ftsection', 'ftSection_3828607'],
            ['ftcustom', 'ftCustom_3828607'],
            ['ft_id', 'ftId_3828607'],
            ['ftimpid','ftImp3828607', 'impID']
        ]
    };
