...
(function(){
  var o = {
    ...
    (function() {
        var p = "3828608", n = JSON.parse('[]'), w = window, f = function(s) {
    ...
    var data = {
        params:window.ftParams_3828608||'',
        GUID:window.ftGUID_3828608||'99999999999',
        confID:window.ftConfID_3828608||'0',
        ftReturn: window.ftReturn_3828608||'',
        keyword:window.ftKeyword_3828608||'',
        ftId:window.ftId_3828608||'',
        imp:window.ftImp3828608,
        ftImpId:window.ftImp3828608 && window.ftImp3828608.impID || '',
        campaignID:'109643',
        cID:'102990',
        pID:'3828608',
        creativeID:'2671441',
        exttrack:[],
        extscript:[""],
        clickTags: ["http://servedby.flashtalking.com/click/8/109643;3828608;2671441;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.workday.com/en-us/industries/hospitality.html?camp=7011B000002hRvV%26eid%3Denus_ba_db_deba_wd_hospedu_web_17.1340"],
        placementDescription:'WorkdayHospitality728x90ENGHTMLNA',
        width:728,
        height:90,
        ...
        divID:'ftdiv3828608',
        phID:'ftpos3828608',
        frameID:'ftframe3828608',
        expID:'ftexpframe3828608',
        altImgID:'ftalt3828608',
        altText:'Click here',
        altImgTarget:'_blank',
        altimghref:'http://servedby.flashtalking.com/click/8/109643;3828608;2671441;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.workday.com/en-us/industries/hospitality.html?camp=7011B000002hRvV%26eid%3Denus_ba_db_deba_wd_hospedu_web_17.1340',
        altImg:'http://servedby.flashtalking.com/imp/8/109643;3828608;204;gif;Flashtalkingcom;WorkdayHospitality728x90ENGHTMLNA/?',
        viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/109643;3828608;271;pixel;Flashtalkingcom;WorkdayHospitality728x90ENGHTMLNA/?',
        stump:'http://servedby.flashtalking.com',
        jsurl:'http://cdn.flashtalking.com/xre/382/3828608/2671441/js/j-3828608-2671441.js',
        file:'http://cdn.flashtalking.com/102990/2671441/index.html',
        safeFrame: window.$sf && window.$sf.ext || false,
        serveDOM:'http://cdn.flashtalking.com',
        statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?140435364-3828608;2671441;',
        adVis:false ? 1 : 0,
        centreAd:true,
        mvt:true,
        segment:window.ftSegment_3828608||'',
        segmentList:window.ftSegmentList_3828608||[],
        ...
        baggyFrameLimit:15,
        append:!!(window.ftImp3828608 && window.ftImp3828608.jsAppend),
        ...
        pageVisible: 'maybe',
        altimgborder: '0',
        secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3828608')&&/^https:/.test(document.getElementById('ftscript_m3828608').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
        scriptLocation: document.getElementById('ftscript_m3828608'),
        ...
        qsVars:[
            ['ftguid', 'ftGUID_3828608'],
            ['ftcfid', 'ftConfID_3828608'],
            ['fttime', 'ftTimestamp_3828608'],
            ['ftsection', 'ftSection_3828608'],
            ['ftcustom', 'ftCustom_3828608'],
            ['ft_id', 'ftId_3828608'],
            ['ftimpid','ftImp3828608', 'impID']
        ]
    };
